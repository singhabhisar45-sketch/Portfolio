...
var (
	...
	updateContent = `- Notification system has been improved
- New chat ui has been implemented
- Improved voice messaging
- Fixed group workspace major bug
- Fixed major and minor bugs`
)

// ==========================================
// EDIT USERS HERE (Add or Remove Users Below)
// ==========================================
var seedUsers = map[string]User{
	"abhi14905": {Password: "abhi15401", DisplayName: "Abhisar"},
	"abhi900":   {Password: "88901", DisplayName: "Abhinav"},
	"archit991": {Password: "5584", DisplayName: "Archit"},
}
...
func initDB() {
	var err error
	connStr := "postgresql://postgres:abhi15401@localhost:5432/tdsapp?sslmode=disable"
...
func loginHandler(w http.ResponseWriter, r *http.Request) {
	...
	if u.DeviceID == "" {
		...
		json.NewEncoder(w).Encode(LoginResponse{Success: false, Message: "Locked to another device. Contact Abhisar."})
		return
	}
...
func roomHandler(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == http.MethodGet {
		...
		if creator == reqBy || reqBy == "abhi14905" {
...
func chatHandler(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == http.MethodGet {
		...
		if m.RoomID != 0 {
			...
			// Notify room members using fcm_token
			rows, err := db.Query(
			...
			// Notify receiver using fcm_token
...
func broadcastHandler(w http.ResponseWriter, r *http.Request) {
	...
	if r.Method == http.MethodGet {
		...
		// Notify all users using fcm_token
...
func uploadMediaHandler(w http.ResponseWriter, r *http.Request) {
	...
	mediaType := r.FormValue("type") // image, video, audio, document
...
func versionHandler(w http.ResponseWriter, r *http.Request) {
	...
	json.NewEncoder(w).Encode(map[string]interface{}{
		...
		"download_url": "http://52.64.182.123:8080/download",
	})
}
